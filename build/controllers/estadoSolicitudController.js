...
class EstadoSolicitudController {
    save(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const dbResponse = yield estadoSolicitud_1.default.create(dataSave);
                res.json({
                    status: true,
    ...
    getAll(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const dbResponse = yield estadoSolicitud_1.default.findAll();
                res.json({
                    status: true,
...
exports.default = estadoSolicitudController;
